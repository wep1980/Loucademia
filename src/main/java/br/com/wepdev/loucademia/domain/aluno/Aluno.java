...
public class Aluno implements Serializable{
	...
	@Embedded // Avisa para JPA que o endereco faz parte da entidade aluno, vão compartilhar o mesmo ID de aluno
	private Endereco endereco = new Endereco();
	
	@Embedded // Avisa para JPA que o telefone faz parte da entidade aluno, vão compartilhar o mesmo ID de aluno
